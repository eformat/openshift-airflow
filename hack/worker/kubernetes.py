## hack for k8s pod operator error. use pod method only.
##
## [2023-01-27, 01:53:01 UTC] {kubernetes_pod.py:641} ERROR - Invalid connection configuration. Options kube_config_path, kube_config, in_cluster are mutually exclusive. You can only use one option at a time.
##
# --- /home/mike/Downloads/kubernetes.py	2023-01-27 12:17:43.437145263 +1000
# +++ hack/worker/kubernetes.py	2023-01-27 12:20:18.162225785 +1000
# @@ -1,4 +1,8 @@
...
# +        #override to use the pod way only
